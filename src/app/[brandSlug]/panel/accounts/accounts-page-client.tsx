...
export function AccountsPageClient({ brandSlug }: { brandSlug: string }) {
  ...
  const handleCreate = React.useCallback(async () => {
    ...
    if (result.success) {
      ...
      fireOnboardingEvent("user-created");
      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            {canManage && (
              <Button size="sm" className="h-8 gap-1.5 text-xs" onClick={() => { setForm(INIT_FORM); setActionError(null); setCreateOpen(true); }} data-tour="account-create">
