  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        {activeLicense ? (
          <ActiveLicenseCard license={activeLicense} brandSlug={brandSlug} />
        ) : (
          <Card>
            ...
            {pastLicenses.map((license) => (
              ...
              >
                <div className="mb-3 flex items-start justify-between gap-2">
                  ...
                  <Badge variant={LICENSE_VARIANTS[license.status] ?? "outline"}>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          ...
          <div>
            ...
            <p className={`mt-0.5 flex items-center gap-1 text-sm font-medium ${isUrgent ? "text-destructive" : ""}`}>
              {isLifetime ? (
                <><Infinity className="size-4" /> No expiry</>
              ) : remaining !== null ? (
