...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  PLATFORM_OWNER: [
    ...
    "payment_account.create", "payment_account.create_global", "payment_account.update", "payment_account.adjust_balance", "payment_account.archive",
    "payment_method.view", "payment_method.link_account", "payment_method.toggle_active", "payment_method.repair", "payment_method.manage_mdr",
  ...
  ADMIN: [
    ...
    "finance_report.view",
    "cashflow.view",
    "finance_transaction.view", "finance_transaction.create_income", "finance_transaction.create_expense",
    "payment_account.view",
    "payment_method.view",
    "store_shift.view", "store_shift.open", "store_shift.close",
    "settings.manage",
