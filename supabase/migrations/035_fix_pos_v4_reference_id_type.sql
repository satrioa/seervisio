-- ============================================================
-- Migration 035: Fix POS V4 reference_id type mismatch
--
-- checkout_pos_v4 was passing v_transaction_id::text (text) as
-- reference_id for inv_stock_movements inserts. But
-- inv_stock_movements.reference_id is uuid type, causing:
--   "column 'reference_id' is of type uuid but expression is of type text"
--
-- Fix: pass v_transaction_id (uuid) directly instead of ::text.
--
-- add_payment_account_movement correctly receives ::text
-- since payment_account_movements.reference_id is text.
-- ============================================================
