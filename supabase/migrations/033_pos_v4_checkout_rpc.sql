-- ============================================================
-- Migration 033: POS V4 Checkout
--
-- Atomic checkout RPC for POS V4 using inv_* tables.
-- Reuses existing helper functions:
--   generate_pos_transaction_number(p_brand_id)
--   resolve_pos_payment_account(p_brand_id, p_branch_id, p_payment_method_id)
--   calculate_pos_mdr(method_type, amount, mdr_pct)
--   add_payment_account_movement(...)
-- Does not touch legacy pos_sales / pos_sale_items.
-- ============================================================
...
comment on function public.checkout_pos_v4 is
  'Atomic POS V4 checkout. Processes quantity items and Unit Second serialized items, creates transaction records, stock movements, and payment account movement.';
